...
[+100 similar | E0909 13:07:09.181236 → E0909 13:21:43.418369 | fqdn×1 {kubernetes.io}, ipv4×1 {127.0.0.1}, k8s_namespace×1 {<FQDN><PATH>}, k8s_volume×1 {oidc-token}, name×14, number×1, path×34, quoted_string×20, uuid×16]
...
Original: 2,000 lines → 128 lines (93.6% reduction)
```
<!-- gen:example:end -->
