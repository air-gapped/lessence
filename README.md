...
[+111 similar | E0909 13:07:09.181236 → E0909 13:21:43.418369 | ipv4×1 {127.0.0.1}, k8s_namespace×17, k8s_volume×1 {oidc-token}, name×30, number×1, path×17, quoted_string×13, uuid×16]
...
Original: 2,000 lines → 126 lines (93.7% reduction)
```
<!-- gen:example:end -->
